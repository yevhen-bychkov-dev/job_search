...
function ConfirmationForm({ generationId, questions, onSuccess }: { generationId: string; questions: ResumeConfirmationQuestion[]; onSuccess: (message: string) => void }) {
